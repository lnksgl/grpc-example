...
@javax.annotation.Generated(
    ...
    comments = "Source: grpc/HelloService.proto")
...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<hello.HelloServiceOuterClass.HelloRequest,
      hello.HelloServiceOuterClass.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = hello.HelloServiceOuterClass.HelloRequest.class,
      responseType = hello.HelloServiceOuterClass.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<hello.HelloServiceOuterClass.HelloRequest,
      hello.HelloServiceOuterClass.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<hello.HelloServiceOuterClass.HelloRequest, hello.HelloServiceOuterClass.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<hello.HelloServiceOuterClass.HelloRequest, hello.HelloServiceOuterClass.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hello.HelloServiceOuterClass.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hello.HelloServiceOuterClass.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(hello.HelloServiceOuterClass.HelloRequest request,
        io.grpc.stub.StreamObserver<hello.HelloServiceOuterClass.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                hello.HelloServiceOuterClass.HelloRequest,
                hello.HelloServiceOuterClass.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public hello.HelloServiceOuterClass.HelloResponse hello(hello.HelloServiceOuterClass.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<hello.HelloServiceOuterClass.HelloResponse> hello(
        hello.HelloServiceOuterClass.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((hello.HelloServiceOuterClass.HelloRequest) request,
              (io.grpc.stub.StreamObserver<hello.HelloServiceOuterClass.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return hello.HelloServiceOuterClass.getDescriptor();
    }
